 ...
 *
 * Given an integer array `nums` sorted in **non-decreasing order**, remove the duplicates _in-place_ such that each
 ...
 *
 * Do not allocate extra space for another array. You must do this by **modifying the input array _in-place_** with
 * (1) extra memory.
 *
 * **Custom Judge:**
 *
