 ...
 * `n - 1` edges. The root of the tree is the node `0`, and each node of
 * the tree has a label which is a lower-case character given in the string
 ...
 * the subtree of the `ith` node which have the same label as node `i`.
 *
...
console.log(countSubTrees(n1, edges1, labels1));
...
const n2 = 5,
    ...
    labels2 = 'aabab';
// Output: [3,2,1,1,1]
console.log(countSubTrees(n2, edges2, labels2));
