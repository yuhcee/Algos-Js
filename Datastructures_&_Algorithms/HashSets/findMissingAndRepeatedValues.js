 ...
 * [`1, n2]`. Each integer appears **exactly once** except `a` which appears **twice** and `b` which
 * is **missing**. The task is to find the repeating and missing numbers `a` and `b`.
 *
